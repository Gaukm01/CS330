...
struct debug_info{
	...
	u32 breakpoint_number;	// number of breakpoint
	u64 functions_oncallstack[MAX_BACKTRACE];
	int stack_top; // top function index 
	int inc_value;     //value by which stack has been increased
